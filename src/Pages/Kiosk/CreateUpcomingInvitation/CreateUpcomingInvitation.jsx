...
import selectDate from "../../../assets/Images/Kiosk_images/UPcoming Date.jpeg";
export default function CreateUpcomingInvitation() {
  return (
    <div className="w-100 d-flex align-items-center justify-content-center flex-column">
      <h1 className="text-muted">Create Upcoming Invitation</h1>
      <Image
        src={SelectCompany}
      ...
      <Image
        ...
        className={"rounded"}
      />
      <Image src={selectDate} alt={"selectDate"} className={"rounded"} />
      <Image
        src={SelectDocument}
        alt={"SelectDocument"}
        className={"rounded"}
